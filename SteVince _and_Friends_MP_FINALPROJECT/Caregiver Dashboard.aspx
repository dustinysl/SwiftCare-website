    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .booking-table th {
            ...
            color: var(--text-light); padding: 16px 12px;
            border-bottom: 2px solid #f0f8fa;
            white-space: nowrap;
        }
        .booking-table td {
            padding: 14px 12px; font-size: 13px; color: var(--text-mid);
        ...
        .client-name { font-weight: 700; color: var(--text-dark); font-size: 13px; white-space: nowrap; }
        .client-loc  { font-size: 11px; color: var(--text-light); white-space: nowrap; }
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="hdnSelectedServices" runat="server" Value="" />
            ...
            <div class="content">
                ...
                <div class="panel" id="panel-profile">
                    ...
                    <div class="section-card">
                        ...
                        <div class="section-card-body">
                            <div class="services-grid">
                                <div class="service-check" id="svc-childcare" onclick="toggleService(this)">
                                    <asp:CheckBox ID="chkChildCare" runat="server" Style="display:none;" />
                                    <div class="check-box">✓</div>
                                    <span class="service-emoji">👶</span>
                                    <span class="service-check-label">Child Care</span>
                                </div>
                                <div class="service-check" id="svc-elderly" onclick="toggleService(this)">
                                    <asp:CheckBox ID="chkElderlyCare" runat="server" Style="display:none;" />
                                    <div class="check-box">✓</div>
                                    <span class="service-emoji">👴</span>
                                    <span class="service-check-label">Elderly Care</span>
                                </div>
                                <div class="service-check" id="svc-pet" onclick="toggleService(this)">
                                    <asp:CheckBox ID="chkPetCare" runat="server" Style="display:none;" />
                                    <div class="check-box">✓</div>
                                    <span class="service-emoji">🐾</span>
                                    <span class="service-check-label">Pet Care</span>
                                </div>
                                <div class="service-check" id="svc-house" onclick="toggleService(this)">
                                    <asp:CheckBox ID="chkHouseSitting" runat="server" Style="display:none;" />
                                    <div class="check-box">✓</div>
                                    <span class="service-emoji">🏠</span>
                                    <span class="service-check-label">House Sitting</span>
                                </div>
                                <div class="service-check" id="svc-special" onclick="toggleService(this)">
                                    <asp:CheckBox ID="chkSpecialNeeds" runat="server" Style="display:none;" />
                                    <div class="check-box">✓</div>
                                    <span class="service-emoji">♿</span>
                    ...
                    <asp:Button ID="btnSaveProfile" runat="server" Text="Save Profile"
                        ...
                        OnClientClick="updateSelectedServices(); return true;" />
                    <asp:Label ID="lblProfileMsg" runat="server" CssClass="server-msg" style="margin-left:14px;" />
                </div>

                
                <div class="panel" id="panel-bookings">
                    <asp:Label ID="lblBookingMsg" runat="server" CssClass="server-msg" style="display:none;" />
                                    ...
                                    <asp:Repeater ID="rptAllBookings" runat="server">
                                        <ItemTemplate>
                                            <tr class="booking-row" data-status="<%# Eval("StatusClass") %>">
                                                ...
                                                <td style="white-space:nowrap;"><%# Eval("Service") %></td>
                                                <td style="white-space:nowrap;"><%# Eval("BookingDate") %></td>
                                                <td style="white-space:nowrap;">₱<%# String.Format("{0:N2}", Eval("Rate")) %>/hr</td>
                                                <td style="white-space:nowrap;font-weight:800;color:var(--teal-dark);">₱<%# String.Format("{0:N2}", Eval("EstTotal")) %></td>
                                                <td style="white-space:nowrap;"><span class="status-pill <%# Eval("StatusClass") %>"><%# Eval("Status") %></span></td>
                                                <td style="white-space:nowrap;">
                                                    <div class="action-btns">
                                                        <asp:LinkButton ID="lbAccept" runat="server"
                                                            ...
                                                            Visible='<%# Eval("StatusClass").ToString() == "pending" %>'>✓ Accept
                                                        </asp:LinkButton>
                                                        <asp:LinkButton ID="lbDecline" runat="server"
                                                            ...
                                                            CommandArgument='<%# Eval("BookingID") %>'
                                                            OnCommand="BookingAction_Command"
                                                            Visible='<%# Eval("StatusClass").ToString() == "pending" %>'>✕ Decline
                                                        </asp:LinkButton>
                                                        ...
                                                        <asp:LinkButton ID="lbComplete" runat="server"
                                                            ...
                                                            CommandArgument='<%# Eval("BookingID") %>'
                                                            OnCommand="BookingAction_Command"
                                                            OnClientClick='<%# "return showCompleteModal(\"" + Eval("ClientName") + "\",\"" + Eval("Service") + "\",\"" + String.Format("{0:N2}", Eval("EstTotal")) + "\");" %>'
                                                            Visible='<%# Eval("StatusClass").ToString() == "confirmed" %>'>✔ Mark Complete
                                                        </asp:LinkButton>
                                                        <span style='<%# Eval("StatusClass").ToString() == "completed" ? "font-size:13px;font-weight:700;color:#2e7d32;" : "display:none;" %>'>✅ Done</span>
                                                        <span style='<%# Eval("StatusClass").ToString() == "cancelled" ? "font-size:13px;font-weight:700;color:#e53935;" : "display:none;" %>'>❌ Cancelled</span>
                                                    </div>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                        ...
                        <div class="section-card-body">
                            ...
                            <div style="margin-top:24px;">
                                <asp:Button ID="btnSaveAvailability" runat="server" Text="💾  Save Availability"
                                    ...
                                    OnClientClick="updateAvailableDays(); return true;" />
        ...
        <script>
            ...
            var svcMap = {
                'svc-childcare': 'Child Care',
                'svc-elderly': 'Elderly Care',
                'svc-pet': 'Pet Care',
                'svc-house': 'House Sitting',
                'svc-special': 'Special Needs Care'
            };

            function updateSelectedServices() {
                var selected = [];
                Object.keys(svcMap).forEach(function (id) {
                    var el = document.getElementById(id);
                    if (el && el.classList.contains('checked')) selected.push(svcMap[id]);
                });
                var hdn = document.getElementById('<%= hdnSelectedServices.ClientID %>');
                if (hdn) hdn.value = selected.join(',');
            }
            ...
            function updateAvailableDays() {
                ...
                var hdn = document.getElementById('hdnAvailableDays');
                if (hdn) hdn.value = selected.join(',');
            }
            ...
            window.addEventListener('DOMContentLoaded', function () {
                ...
                var checkedSvcIDs = '<%= hdnSelectedServices.Value %>'.split(',').filter(function (s) { return s.trim() !== ''; });

                var idMap = { '1': 'svc-childcare', '2': 'svc-elderly', '3': 'svc-special', '4': 'svc-pet', '5': 'svc-house' };
                ['svc-childcare', 'svc-elderly', 'svc-pet', 'svc-house', 'svc-special'].forEach(function (id) {
                    var el = document.getElementById(id);
                    if (el) {
                ...
                checkedSvcIDs.forEach(function (svcID) {
                    var elId = idMap[svcID.trim()];
                    if (elId) {
                ...
                var bookingMsg = '<%= lblBookingMsg.Text %>';
                if (bookingMsg && bookingMsg.trim() !== '') showToast(bookingMsg);
            });
        </script>
            ...
            <div style="background:white;border-radius:20px;width:90%;max-width:420px;box-shadow:0 20px 60px rgba(10,42,74,0.25);overflow:hidden;">
                ...
                <div style="padding:22px 26px;">
                    ...
                    <div style="display:flex;gap:10px;">
                        ...
                        <button type="button" onclick="confirmComplete()" id="btnModalComplete" style="flex:2;padding:12px;border-radius:10px;border:none;background:linear-gradient(135deg,#2e7d32,#00838f);color:white;font-family:'Nunito',sans-serif;font-size:14px;font-weight:800;cursor:pointer;">✔ Confirm Complete</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            var _pendingLink = null;

            function showCompleteModal(clientName, service, estTotal) {
                ...
                _pendingLink = document.activeElement;
            ...
            function confirmComplete() {
                ...
                if (_pendingLink) {
                    ...
                    _pendingLink.removeAttribute('onclick');
                    _pendingLink.click();
                }
            }
