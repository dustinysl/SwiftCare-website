    ...
    <form id="form1" runat="server">
        ...
        <script>
            ...
            function openModal(id, name, location, phone, services, rate, bio, availStatus, availDays) {
                ...
                // Show loading state then fetch real reviews
                ...
                // Fetch reviews from server via WebMethod
                ...
                .then(function(data) {
                    ...
                    // Build star display from average
                    var avg   = d.avgRating;
            ...
            // Escape HTML to prevent XSS in review content
