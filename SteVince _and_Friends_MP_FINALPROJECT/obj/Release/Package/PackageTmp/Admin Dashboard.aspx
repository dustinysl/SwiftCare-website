<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin Dashboard.aspx.cs" Inherits="SteVince__and_Friends_MP_FINALPROJECT.Admin_Dashboard" %>
...
<head runat="server">
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .admin-badge { display: inline-flex; align-items: center; gap: 7px; background: rgba(239,154,154,0.2); border: 1px solid rgba(239,154,154,0.4); color: #ef9a9a; padding: 5px 14px; border-radius: 50px; font-size: 13px; font-weight: 700; }
                ...
                <div class="panel active" id="panel-overview">
                    <div class="admin-hero">
                        ...
                        <div class="admin-hero-info">
                            ...
                            <div class="admin-badge"><div class="badge-dot"></div> System Active</div>
                        </div>
                    </div>
                    <div class="stats-row">
                        <div class="stat-card">
