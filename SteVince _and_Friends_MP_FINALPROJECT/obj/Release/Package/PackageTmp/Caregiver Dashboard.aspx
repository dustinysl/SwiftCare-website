    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .booking-table th {
            ...
            color: var(--text-light); padding: 0 16px 12px;
            border-bottom: 2px solid #f0f8fa;
        }
        .booking-table td {
            padding: 14px 16px; font-size: 14px; color: var(--text-mid);
...
<body>
    <form id="form1" runat="server">
                                                ...
                                                <td>
                                                    <div class="action-btns">
                                                        ...
                                                        <asp:LinkButton ID="lbComplete" runat="server"
                                                            ...
                                                            Visible='<%# Eval("StatusClass").ToString() == "confirmed" %>'>
                                                            ✔ Mark Complete
                                                        </asp:LinkButton>
                                                    </div>
                                                </td>
                            ...
                            <div class="time-slots">
                                <div class="time-slot-row">
                                    ...
                                    <div class="time-inputs">
                                        <asp:TextBox ID="txtMorningStart" runat="server" CssClass="time-input" TextMode="Time" Text="08:00" />
                                        <span class="time-sep">to</span>
                                        <asp:TextBox ID="txtMorningEnd" runat="server" CssClass="time-input" TextMode="Time" Text="12:00" />
                                    </div>
                                </div>
                                <div class="time-slot-row">
                                    <span class="time-slot-label">Afternoon</span>
                                    <div class="time-inputs">
                                        <asp:TextBox ID="txtAfternoonStart" runat="server" CssClass="time-input" TextMode="Time" Text="13:00" />
                                        <span class="time-sep">to</span>
                                        <asp:TextBox ID="txtAfternoonEnd" runat="server" CssClass="time-input" TextMode="Time" Text="17:00" />
                                    </div>
                                </div>
                                <div class="time-slot-row">
                                    <span class="time-slot-label">Evening</span>
                                    <div class="time-inputs">
                                        <asp:TextBox ID="txtEveningStart" runat="server" CssClass="time-input" TextMode="Time" Text="18:00" />
                                        <span class="time-sep">to</span>
                                        <asp:TextBox ID="txtEveningEnd" runat="server" CssClass="time-input" TextMode="Time" Text="21:00" />
                                    </div>
                                </div>
                            </div>
        ...
        <!-- Hidden field to store selected available days for server-side save -->
