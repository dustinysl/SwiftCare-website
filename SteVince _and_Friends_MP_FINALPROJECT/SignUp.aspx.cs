...
namespace SteVince__and_Friends_MP_FINALPROJECT
{
    public partial class SignUp : System.Web.UI.Page
    {
        ...
        protected void btnSignUp_Click(object sender, EventArgs e)
        {
            ...
            string role = hdnRole.Value; // "User" or "Caregiver"
            ...
            try
            {
                ...
                using (SqlConnection conn = new SqlConnection(connStr))
                {
                    ...
                    // Manually generate next UserID since it is NOT an IDENTITY column
                    int newUserID = 1;
                    ...
                    // If Caregiver, create a blank CaregiverProfiles row
                    if (role == "Caregiver")
                    {
                        // Get next CaregiverID manually
